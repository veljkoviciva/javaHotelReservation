    ...
    <body>
        <div class="container">
            <div class="row">
                ...
                <form action="RezervacijaSunsetServlet" method="post" name="rezervacijaStarPlus">
                    ...
                    <table border="1" style="color: white">
                        ...
                        <% 
                            ...
                            sveSobe = Queries.izborSobaPoHotelu(3002);
                        ...
                        <tr align="center">
                            ...
                            <td>
                                ...
                                <% 
                                   ...
                                   if(sesija.getAttribute("uloga").equals("Admin") || id==6) { 
                                %>
                            <td style="border: none"><!--<input type="submit" value="Izmeni" id="btnIzmeniSobu">-->
                                <a href="updateSobe.jsp?id=<%= lista.getIDSobe() %>&proces=updateSobaStarPlus" id="btnIzmeniSobu">Izmeni</a>
                            <td>
                            <td style="border: none"><!--<input type="submit" value="Izbrisi" id="btnIzbrisiSobu">-->
                                <a href="DeleteSobeServlet?id=<%= lista.getIDSobe() %>&proces=deleteSobaStarPlus" id="btnIzbrisiSobu">Izbrisi</a>
                            <td>
                                <% } %>
                        </tr>
                        <% } %>
